...
const cleanupString = (str: string) => {
  return str
    .replace(/=20/g, '') // Remove =20 artifacts
...
<head>
    ...
    <style>
      ...
      .info-row { margin: 10px 0; color: #666666; display: flex; justify-content: space-between; align-items: center; }
      ...
      .photo-link-container { margin-top: 10px; text-align: center; }
      .photo-link { display: inline-block; padding: 8px 16px; background-color: #8B5CF6; color: white !important; text-decoration: none; border-radius: 4px; font-size: 14px; }
      .photo-link:hover { background-color: #7C3AED; }
    </style>
</head>
<body>
    <div class="container">
